...
# Gemma chat templates are based on
...
# Noting some top 5 refusal tokens. But really a vast majority of the probability is placed on the first.
GEMMA_REFUSAL_TOKS_EXTRA = [235285, 1718, 651, 590, 2169] # ['I', 'It', 'The', ' I', 'As']
